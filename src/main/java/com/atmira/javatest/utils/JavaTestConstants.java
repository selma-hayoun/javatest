package com.atmira.javatest.utils;
...
public class JavaTestConstants {
    ...
    /*Variables generales*/
    public static final String STR_PLANET_EARTH = "EARTH";
    public static final String STR_PLANET_URANUS = "Uranus";
    ...
    public static final String TESTS_NASA_RESPONSE_JSON = "nasa_response_json.json";
    public static final String TESTS_ASTEROIDS_RESULT = "asteroids_test_result.json";
